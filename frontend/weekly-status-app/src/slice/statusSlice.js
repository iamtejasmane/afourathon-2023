...
export const getStatusOfUser = createAsyncThunk(
  "getStatusOfUser",
  async ({ project_id }) => {
    const response = await getUserStatusApi({ project_id });
...
export const statusSlice = createSlice({
  ...
  reducers: {
    ...
    setselectedProjectForStatusUpdate: (state, action) => {
      state.selectedProjectForStatusUpdate = action.payload;
    },
    unsetselectedProjectForStatusUpdate: (state, action) => {
      state.selectedProjectForStatusUpdate = {};
    },
  },
